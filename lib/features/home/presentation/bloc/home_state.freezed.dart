...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(HomeEntity data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(HomeEntity data)? loaded,
...
abstract class Loaded implements HomeState {
  const factory Loaded(final HomeEntity data) = _$LoadedImpl;
...
abstract class Error implements HomeState {
  const factory Error(final Failure message) = _$ErrorImpl;
